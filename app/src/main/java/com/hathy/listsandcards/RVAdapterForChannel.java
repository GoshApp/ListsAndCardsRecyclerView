...
public class RVAdapterForChannel extends RecyclerView.Adapter<RVAdapterForChannel.ChannelViewHolder> {
    ...
    RVAdapterForChannel(Context context, ArrayList<HashMap<String, String>> list, CustomItemClickListener listener){
    ...
    public void onBindViewHolder(ChannelViewHolder personViewHolder, int i) {
        ...
        personViewHolder.personName.setText(item.get(Utils.KEY_PUBLISHEDAT));
        // Set image to imageview
        IMAGE_LOADER.get(item.get((Utils.KEY_URL_THUMBNAILS)),
                ImageLoader.getImageListener((personViewHolder.personPhoto),
